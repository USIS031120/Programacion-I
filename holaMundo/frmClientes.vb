Public Class frmClientes
    ...
    Sub mostrarDatos()
        If dataTable.Rows.Count > 0 Then
            Me.Tag = dataTable.Rows(posicion).Item(0).ToString() 'ID de Cliente
        ...
        Else
            limpiarDatosCliente()
            MessageBox.Show("No hay registros que mostrar", "Registros de Clientes", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
    ...
    Private Sub btnEliminarCliente_Click(sender As Object, e As EventArgs) Handles btnEliminarCliente.Click
        If (MessageBox.Show("Esta seguro de borrar a " + txtNombreCliente.Text, "Registro de Cliente", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes) Then
